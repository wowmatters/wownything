...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("id.wowmatters.wownything.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("id.wowmatters.wownything.security.DomainUserDetailsService", "createSpringSecurityUser");
